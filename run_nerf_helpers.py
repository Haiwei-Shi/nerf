...
class Embedder:
    ...
    def embed(self, inputs):
        ...
        # here is the definition of the positional encoding functions
        # but has not compute the arrays yet
        # in the get_embedder(), it outputs this function list
        # and then compute at the run_nerf.py
